...
first_url = 'https://bj.lianjia.com/ershoufang/'+chengqu+'/pg'
...
def house_info(i):
    ...
    for item in list:
        ...
        mylist.append([count,url, title, diqu, xiaoqu, zongjia, danjia, huxing, mianji, chaoxiang, zhuangxiu,
    dianti, louceng,zonggao, niandai, louxing, ditie, VR, taxfree, kanfang, guanzhu,daikan,id])
...
def save_to_excel(mylist):
    ...
    headers = (
    'No','ID', 'title', 'diqu',  'xiaoqu', 'zongjia', 'danjia','huxing', 'mianji', 'chaoxiang', 'zhuangxiu',
    ...
    file_name = "D:\lianjia_"+chengqu+".xlsx"
